...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        $tags = Tag::all();
        return view('editor.post.create',compact('categories','tags'));
    }
...
//            make unipue name for image
    ...
    public function show(Post $post)
    {
        ...
        return view('editor.post.show',compact('post'));
    }
    ...
    public function edit(Post $post)
    {
        ...
        $categories = Category::all();
        $tags = Tag::all();
        return view('editor.post.edit',compact('post','categories','tags'));
    }
