...
@section('content')
    <div class="slider display-table center-text">
        <h1 class="title display-table-cell"><b>{{ $editor->name }}</b></h1>
    </div><!-- slider -->
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="card h-100">
                                        <div class="single-post post-style-1">
                                            ...
                                            <a class="avatar" href="{{ route('editor.profile',$post->user->username) }}"><img src="{{ Storage::disk('public')->url('profile/'.$post->user->image) }}" alt="Profile Image"></a>
                ...
                <div class="col-lg-4 col-md-12 ">
                    ...
                    <div class="single-post info-area ">
                        ...
                        <div class="about-area">
                            ...
                            <p>{{ $editor->name }}</p><br>
                            <p>{{ $editor->about }}</p><br>
                            <strong>Editor Since: {{ $editor->created_at->toDateString() }}</strong><br>
                            <strong>Total Posts : {{ $editor->posts->count() }}</strong>
                        </div>
