                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <p class="text-sm mb-0">
                            This is the list of all packages. You can add, edit or delete packages from here.
                        </p>
                        <div class="ps-4">
                            <a href="{{ route('admin.package.create') }}" class="btn bg-gradient-info btn-icon-only mb-0 mt-3" data-toggle="modal" data-target="#new-board-modal">
                        ...
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            @foreach($packages as $key=>$package)
                                <tr>
                                    ...
                                    <td class="text-sm font-weight-normal">{{$package->type}}</td>

                                    <td class="text-sm font-weight-normal">{{$package->created_at}}</td>
                                    <td >
                                        <div class="dropdown ">
                                            ...
                                            <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable2" style="">
                                                <li><a  class="dropdown-item border-radius-md" href="{{ route('admin.package.edit',$package->id) }}" >
