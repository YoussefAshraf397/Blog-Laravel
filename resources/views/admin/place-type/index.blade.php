            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h5 class="mb-0">Place Type List</h5>
                        <p class="text-sm mb-0">
                            This is the list of all place types. You can add, edit or delete place types from here.
                        </p>
                        <div class="ps-4">
                            <a href="{{ route('admin.place-type.create') }}" class="btn bg-gradient-info btn-icon-only mb-0 mt-3" data-toggle="modal" data-target="#new-board-modal">
                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tbody>
                            @foreach($placeTypes as $key=>$placeType)
                                <tr>
...
{{--                                    <td class="text-sm font-weight-normal">{{$placeType->status}}</td>--}}
                                    <td class="text-sm font-weight-normal">
                                        <div>
                                            <img src="{{URL::to('/')}}{{'/place-type/'.$placeType->icon}}" class="avatar avatar-sm me-3" alt="avatar image">
                                        </div>
                                    </td>
                                    @php
                                        $nameArray = json_decode($placeType->name, true);
                                    @endphp
                                    ...
                                    <td class="text-sm font-weight-normal">{{$placeType->created_at}}</td>
                                    <td >
                                        <div class="dropdown ">
                                            ...
                                            <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable2" style="">
                                                <li><a  class="dropdown-item border-radius-md" href="{{ route('admin.place-type.edit',$placeType->id) }}" >
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-form-{{ $placeType->id }}"
                                                          action="{{ route('admin.place-type.destroy',$placeType->id) }}"
