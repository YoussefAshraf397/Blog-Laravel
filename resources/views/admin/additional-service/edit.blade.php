...
<div class="row">
    <div class="col-lg-9 col-12 mx-auto">
        ...
        <div class="card card-body mt-4">
            <form action="{{ route('admin.additional-service.update',$additionalService->id) }}" method="POST"
                ...
                @endphp
                <h6 class="mb-0">Edit Additional Service</h6>
                <p class="text-sm mb-0">Edit the additional service</p>
                ...
                <div class="row mt-3">
                    <div class="col-12 col-sm-6">
                        <label>Unit EN</label>
                        <input name="unit_en" class="multisteps-form__input form-control" type="text" value="{{$unitArray['en']}}" />
                    </div>
                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                        <label>Unit AR</label>
                        <input name="unit_ar" class="multisteps-form__input form-control" type="text" value="{{$unitArray['ar']}}" />
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end mt-4">
                    <a type="button"  href="{{ route('admin.additional-service.index') }}" class="btn btn-light m-0">Cancel</a>
                    <button type="submit" name="button" class="btn bg-gradient-info m-0 ms-2">Update Additional Service</button>
                </div>
            </form>
        </div>
    </div>
