                ...
                <div class="multisteps-form">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 m-auto">
                            <form class="multisteps-form__form mb-8" action="{{ route('admin.place.update',$place->id) }}" method="POST" enctype="multipart/form-data" id="identifier">
                                @csrf
                                @method('PUT')

                                @php
                                    $nameArray = json_decode($place->name, true);
                                    $descriptionArray = json_decode($place->details, true);
                                    $cancellationPolicyArray = json_decode($place->cancellation_policy, true);
                                @endphp
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="status" class="multisteps-form__select form-control">
                                                    @foreach($placeStatus as $status)
                                                        <option {{$status == $place->status ? 'selected="selected"' : ''}} value="{{$status}}">{{$status}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <select name="category_group" class="multisteps-form__select form-control">
                                                    <option {{'A' == $place->category_group ? 'selected="selected"' : ''}} value="A">A</option>
                                                    <option {{'B' == $place->category_group ? 'selected="selected"' : ''}} value="B">B</option>
                                                    <option {{'C' == $place->category_group ? 'selected="selected"' : ''}} value="C">C</option>
                                                    <option {{'D' == $place->category_group ? 'selected="selected"' : ''}} value="D">D</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="place_type_id" class="multisteps-form__select form-control">
                                                    @foreach($placeTypes as $placeType)
                                                        <option {{$placeType->id == $place->place_type_id ? 'selected="selected"' : ''}} value="{{$placeType->id}}">{{json_decode($placeType->name, true)['en']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <select name="property_type_id" class="multisteps-form__select form-control">
                                                    @foreach($propertyTypes as $propertyType)
                                                        <option {{$propertyType->id == $place->property_id ? 'selected="selected"' : ''}} value="{{$propertyType->id}}">{{json_decode($propertyType->name, true)['en']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="city_id" class="multisteps-form__select form-control">
                                                    @foreach($cities as $city)
                                                        <option {{$city->id == $place->city_id ? 'selected="selected"' : ''}} value="{{$city->id}}">{{json_decode($city->name, true)['en']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <select name="user_id" class="multisteps-form__select form-control">
                                                    @foreach($users as $user)
                                                        <option {{$user->id == $place->user_id ? 'selected="selected"' : ''}} value="{{$user->id}}">{{$user->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="multisteps-form__content">
                                        ...
                                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                                            <div>
                                                <div class="form-check form-switch mb-0">
                                                    <input
                                                        name="requires_professional_photographer"
                                                        class="form-check-input"
                                                        type="checkbox"
                                                        id="flexSwitchCheckDefault0"
                                                        {{$place->requires_professional_photographer == 1 ? 'checked' : ''}}
                                                    >
                                                </div>
                                            </div>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                                            <div>
                                                <div class="form-check form-switch mb-0">
                                                    <input
                                                        name="accepts_reservations_automatically"
                                                        class="form-check-input"
                                                        type="checkbox"
                                                        id="flexSwitchCheckDefault0"
                                                        {{$place->accepts_reservations_automatically == 1 ? 'checked' : ''}}
                                                    >
                                                </div>
                                            </div>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                                            <div>
                                                <div class="form-check form-switch mb-0">
                                                    <input
                                                        name="accepts_promocodes"
                                                        class="form-check-input"
                                                        type="checkbox"
                                                        id="flexSwitchCheckDefault0"
                                                        {{$place->accepts_promocodes == 1 ? 'checked' : ''}}
                                                    >
                                                </div>
                                            </div>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                                            <div>
                                                <div class="form-check form-switch mb-0">
                                                    <input
                                                        name="support_overnight"
                                                        class="form-check-input"
                                                        type="checkbox"
                                                        id="flexSwitchCheckDefault0"
                                                        {{$place->support_overnight == 1 ? 'checked' : ''}}
                                                    >
                                                </div>
                                            </div>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                                            <div>
                                                <div class="form-check form-switch mb-0">
                                                    <input
                                                        name="can_use_additional_services"
                                                        class="form-check-input"
                                                        type="checkbox"
                                                        id="flexSwitchCheckDefault0"
                                                        {{$place->can_use_additional_services == 1 ? 'checked' : ''}}
                                                    >
                                                </div>
                                            </div>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                                            <div>
                                                <div class="form-check form-switch mb-0">
                                                    <input
                                                        name="is_accepting_additional_service"
                                                        class="form-check-input"
                                                        type="checkbox"
                                                        id="flexSwitchCheckDefault0"
                                                        {{$place->is_accepting_additional_service == 1 ? 'checked' : ''}}
                                                    >
                                                </div>
                                            </div>
                                            <div class="ms-2">
                                    ...
                                    <div class="multisteps-form__content mt-3">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input name="price_per_day_on_week_days" class="multisteps-form__input form-control" type="text" value="{{$place->price_per_day_on_week_days}}" />
                                            </div>
                                            <div class="col-6">
                                                <label>Price Per Day On Week End</label>
                                                <input name="price_per_day_on_week_end" class="multisteps-form__input form-control" type="text" value="{{$place->price_per_day_on_week_end}}" />
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <input name="custom_commission" class="multisteps-form__input form-control" type="text" value="{{$place->custom_commission}}" />
                                            </div>
