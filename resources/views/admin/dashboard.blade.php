        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                ...
                <div class="info-box bg-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">TOTAL Editors</div>
                        <div class="number count-to" data-from="0" data-to="{{ $editor_count }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
                <div class="info-box bg-deep-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">TODAY Editor</div>
                        <div class="number count-to" data-from="0" data-to="{{ $new_editors_today }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                @foreach($active_editors as $key=>$editor)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $editor->name }}</td>
                                        <td>{{ $editor->posts_count }}</td>
                                        <td>{{ $editor->comments_count }}</td>
                                        <td>{{ $editor->favorite_posts_count }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
