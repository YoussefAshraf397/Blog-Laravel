            ...
            <div class="col-lg-9 col-12 mx-auto">
                ...
                <div class="card card-body mt-4">
                    <form action="{{ route('admin.category.update',$category->id) }}" method="POST"
                        ...
                        <p class="text-sm mb-0">Edit package</p>
                        ...
                        <select name="status" class="multisteps-form__select form-control">
                            ...
                            <option value="suspend" {{$category->status == 'suspend' ? 'selected="selected"' : '' }}>suspend</option>
                        </select>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" name="button" class="btn bg-gradient-info m-0 ms-2">Update Category</button>
                        </div>
                    </form>
                </div>
            </div>
