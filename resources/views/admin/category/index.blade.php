            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <p class="text-sm mb-0">
                        This is the list of all categories. You can add, edit or delete categories from here.
                    </p>
                    <div class="ps-4">
                        <a href="{{ route('admin.category.create') }}" class="btn bg-gradient-info btn-icon-only mb-0 mt-3" data-toggle="modal" data-target="#new-board-modal">
                ...
                <div class="table-responsive">
                    <table class="table table-flush" id="datatable-basic">
                        ...
                        <tr>
                            ...
                            @php
                                $nameArray = json_decode($category->name, true);
                            @endphp
                            ...
                            <td class="text-sm font-weight-normal">{{$category->status}}</td>
                            <td class="text-sm font-weight-normal">
                                <div>
                                    <img src="{{URL::to('/')}}{{'/category/'.$category->icon}}" class="avatar avatar-sm me-3" alt="avatar image">
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="dropdown ">
                                    ...
                                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable2" style="">
                                        <li><a  class="dropdown-item border-radius-md" href="{{ route('admin.category.edit',$category->id) }}" >
